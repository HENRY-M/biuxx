...
public class Startup {
	...
	public static void main(String[] args) {
	    ...
	    String nodeName = "A";//StringUtils.trimToEmpty(System.getProperty("node.name"));
	    
	    String resPath = getResoucesPath(Startup.class);
	    
        DubboLogger.registerLocationInfo("BIUXX", "SCHEDULE", nodeName);
